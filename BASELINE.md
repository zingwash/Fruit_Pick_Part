...
- 当前基准标签：`baseline-2026-07-26`
- 上一基准标签：`baseline-2026-07-24`
- 稳定维护分支：`codex/baseline-stable`
- 算法与架构优化分支：`main`
- 当前基准更新日期：2026-07-26

当前基准已覆盖至成员改动整理版，包含 2026-07-25 的新视觉模型、类别显示和实机参数。`baseline-2026-07-24` 继续保留为覆盖前的原始回退点。
...
1. `baseline-2026-07-24` 和 `baseline-2026-07-26` 都是不可变快照，不移动、不覆盖。
